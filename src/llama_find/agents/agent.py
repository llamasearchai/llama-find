...
class Agent:
    ...
    def __init__(
        ...
        self.function_caller = LlamaFunctionCaller(
            model_path=model_path, use_mlx=use_mlx
        )
...
class SearchAgent(Agent):
    ...
    def __init__(
        ...
        try:
            ...
            self.register_capability(
                "calculate", self.calculate, "Perform a calculation"
            )
            self.register_capability(
...
class AgentFactory:
    ...
    def create_agent(
        ...
        if agent_type.lower() == "search":
            return SearchAgent(
                model_path=model_path, system_prompt=system_prompt, use_mlx=use_mlx
            )
