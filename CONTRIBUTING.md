# Contributing to Llama Find

Thank you for your interest in contributing to Llama Find! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to Llama Find:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llama-find.git
   cd llama-find
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llama-find.git
   ```
...
By contributing to Llama Find, you agree that your contributions will be licensed under the project's MIT License.
